...
function Search() {
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/books?search=${book}`, {
        headers: {
  ...
  return searchResults && userEmail ? (
    <div>
      <div
        style={{
          paddingTop: 100,
      ...
      >
        <h1>Search Results for "{book}" are:</h1>
      </div>
      <div
        style={{
          display: "flex",
          ...
          <div key={index}>
            ...
            >
              <div style={{ flex: 1, overflow: "hidden" }}>
                <Tooltip
                  title={`${book.avg_rating.toString().substring(0, 3)}⭐`}
                  arrow
                  placement="top"
                >
                  <img
                    ...
                    width={200}
                    height={300}
                    alt={`Book cover for ${book.image_url}`}
                  />
                </Tooltip>
                <Typography
                  style={{
